...
class OrderDetailsWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final storeInfo = orderItems.isNotEmpty
        ? orderItems.first
        : WidgetAction(
            buttonText: '',
            title: '',
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          SizedBox(
                            width: 130,
                            child: Text(
                              _formatCurrency(totalItem.currencySymbol ?? '',
                                  totalItem.productPrice ?? 0),
                              style: AppTextStyles.restaurantTitle.copyWith(
                                fontSize: 14,
                                fontWeight: FontWeight.w700,
                                color: Color(0xFF242424),
