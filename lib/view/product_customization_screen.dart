                ...
                child: ElevatedButton(
                  onPressed: () {
                    if (state.selectedVariant != null) {
                      ...
                      _cartManager.addProductWithCustomizations(widget.product.childProductId, customizations);
                      
                      _cartManager.setLastAddedCustomization(
                        widget.product.childProductId,
                        widget.product.productName,
                        customizations,
                      );
