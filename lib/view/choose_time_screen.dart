...
class ChooseTimeScreen extends StatefulWidget {
  ...
  /// Present the ChooseTimeScreen as a modal bottom sheet
...
class _ChooseTimeScreenState extends State<ChooseTimeScreen> {
            ...
            child: BlocConsumer<StoreDetailsBloc, StoreDetailsState>(
              listener: (context, state) {
                if (state is StoreDetailsLoadSuccess) {
                  ...
                  setState(() {
                    dateTimeSlotsMap[state.date] = state.slots.map((slot) => '${slot.fromStr} - ${slot.toStr}').toList();
                  });
                    ...
                    return Padding(
                      ...
                      child: GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            color: isSelected ? AppConstants.appThemeColor : const Color(0xFFF5F7FF),
                            border: isSelected
                                ? null
                                : Border.all(
  ...
  Widget _buildRadioButton(bool isSelected) {
    return Container(
      ...
      decoration: BoxDecoration(
        border: Border.all(
          color: isSelected ? AppConstants.appThemeColor : const Color(0xFFEEF4FF),
          width: 0.833333,
        ),
